...
public class Tugas2 {
    ...
    public static void volume(int rusuk) {
        ...
        System.out.println("Volume kubus tersebut adalah " +
                hasilVolume + " cm3.");
        System.out.println("==================================");
    }
    ...
    public static void luasPermukaan(int rusuk) {
        ...
        System.out.println("Luas permukaan kubus tersebut adalah " +
                hasilLuas + " cm2.");
        System.out.println("==================================");
    }
    ...
    public static void keliling(int rusuk) {
        ...
        System.out.println("Keliling kubus tersebut adalah " +
                hasilKeliling + " cm.");
        System.out.println("==================================");
    }

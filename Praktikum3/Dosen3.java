...
public class Dosen3 {
    ...
    public static void tambahData(Dosen3[] arrayOfDosen) {
        Scanner sc = new Scanner(System.in);
        for (int i = 0; i < arrayOfDosen.length; i++) {
            arrayOfDosen[i] = new Dosen3();
    ...
    public static void tampilkanData(Dosen3[] arrayOfDosen) {
        System.out.println("\n=== Data Semua Dosen ===");
        for (Dosen3 dosen : arrayOfDosen) {
            System.out.println("-------------------------");
    ...
    public static void hitungJumlahPerJenisKelamin(Dosen3[] arrayOfDosen) {
        int jumlahPria = 0;
        int jumlahWanita = 0;
    ...
    public static void hitungRataRataUsiaPerJenisKelamin(Dosen3[] arrayOfDosen) {
        int usiaPria = 0;
        int usiaWanita = 0;
        int jumlahPria = 0;
        int jumlahWanita = 0;
    ...
    public static void infoDosenPalingTua(Dosen3[] arrayOfDosen) {
    ...
    public static void infoDosenPalingMuda(Dosen3[] arrayOfDosen) {
